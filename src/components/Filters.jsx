...
export default function Filters({filter, onFilterChange, dispatch, tasks}) {
  ...
  return (
    <section className="w-11/12 mx-auto my-8 flex gap-4">
        <button 
        ...
        <button 
          className={`border border-zinc-200 rounded-md py-2 px-3 ml-auto flex items-center gap-2 text-red-500 font-semibold cursor-not-allowed hover:shadow hover:bg-red-50 transition-all ${!hasCompleted ? disabledClass : "opacity-100 cursor-pointer"}`}
